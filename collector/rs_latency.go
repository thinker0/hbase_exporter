...
func NewRsLatency(logger log.Logger, url *url.URL) *RsLatency {
	return &RsLatency{
		...
		metrics: map[string]*prometheus.Desc{
			...
			"deleteBatchTime_999th_percentile":    newLatencyMetric("deleteBatchTime_999th_percentile", "The description of deleteBatchTime_999th_percentile"),
			...
			"appendTime_999th_percentile":         newLatencyMetric("appendTime_999th_percentile", "The description of appendTime_999th_percentile"),
			...
			"getTime_999th_percentile":            newLatencyMetric("getTime_999th_percentile", "The description of getTime_999th_percentile"),
			...
			"incrementTime_999th_percentile":      newLatencyMetric("incrementTime_999th_percentile", "The description of incrementTime_999th_percentile"),
			...
			"putBatchTime_999th_percentile":       newLatencyMetric("putBatchTime_999th_percentile", "The description of putBatchTime_999th_percentile"),
			...
			"putTime_999th_percentile":            newLatencyMetric("putTime_999th_percentile", "The description of putTime_999th_percentile"),
			...
			"scanSize_999th_percentile":           newLatencyMetric("scanSize_999th_percentile", "The description of scanSize_999th_percentile"),
			...
			"checkAndMutateTime_999th_percentile": newLatencyMetric("checkAndMutateTime_999th_percentile", "The description of checkAndMutateTime_999th_percentile"),
			...
			"checkAndPutTime_999th_percentile":    newLatencyMetric("checkAndPutTime_999th_percentile", "The description of checkAndPutTime_999th_percentile"),
			...
			"checkAndDeleteTime_999th_percentile": newLatencyMetric("checkAndDeleteTime_999th_percentile", "The description of checkAndDeleteTime_999th_percentile"),
			...
			"scanTime_999th_percentile":           newLatencyMetric("scanTime_999th_percentile", "The description of scanTime_999th_percentile"),
			...
			"deleteTime_999th_percentile":         newLatencyMetric("deleteTime_999th_percentile", "The description of deleteTime_999th_percentile"),
...
func (r *RsLatency) fetchAndDecodeRsLatency() (string, string, error) {
	...
	url := url.URL{
		...
		Host:     u.Host,
		User:     u.User,
		RawQuery: "qry=Hadoop:service=HBase,name=RegionServer,sub=TableLatencies",
	}
		...
		if jmx.Metric == "deleteBatchTime_num_ops" {
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of deleteBatchTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of appendTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of getTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of incrementTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of putBatchTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of putTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of scanSize_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of checkAndMutateTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of checkAndPutTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of checkAndDeleteTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of scanTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
			...
			ch <- prometheus.MustNewConstMetric(
				prometheus.NewDesc(
					...
					"The number of deleteTime_999th_percentile.",
					defaultHBaseRsLatencyLabels, nil,
				),
				Type,
				Value,
